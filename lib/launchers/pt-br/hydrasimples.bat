...
color 3
echo. 
echo                             Bem-vindo ao menu simplificado!
echo                              Escolha uma das opcoes abaixo
echo.
echo    1) Ativador Windows/Office                ^| 10) Otimizar o Windows
echo    2) Remover mensagem de ativacao do Office ^| 11) Modo mais desempenho           
echo    3) Limpeza de temporarios                 ^| 12) Excluir certificados vencidos          
echo    4) Resolver problemas com HD              ^| 13) Backup de arquivos                     
echo    5) Resolver problemas com internet        ^| 14) Organizar Area de trabalho e Downloads          
echo    6) Resolver problemas com impressoras     ^| 15) Sincronizar Relogio                    
echo    7) Resolver problemas com Windows         ^| 16) Corrigir problemas do Java             
echo    8) Corrigir atualizacao do Windows        ^| 17) Buscar arquivos de IRPF          
echo    9) Atualizar todos os programas      
echo.
set/p simplesbr= Digite sua opcao:

if %simplesbr% equ 1 goto 1
if %simplesbr% equ 2 goto 2
if %simplesbr% equ 3 goto 3
if %simplesbr% equ 4 goto 4
if %simplesbr% equ 5 goto 5
if %simplesbr% equ 6 goto 6
if %simplesbr% equ 7 goto 7
if %simplesbr% equ 8 goto 8
if %simplesbr% equ 9 goto 9
if %simplesbr% equ 10 goto 10
if %simplesbr% equ 11 goto 11
if %simplesbr% equ 12 goto 12
if %simplesbr% equ 13 goto 13
if %simplesbr% equ 14 goto 14
if %simplesbr% equ 15 goto 15
if %simplesbr% equ 16 goto 16
if %simplesbr% equ 17 goto 17
